...
exports.handler = async (event) => {
  ...
  try {
    const { product_id, pickup_datetime, return_datetime } = JSON.parse(event.body);
    ...
    // Overlap condition: existing pickup < requested return AND existing return > requested pickup
    ...
    const available = bookedCount < availableQty;
